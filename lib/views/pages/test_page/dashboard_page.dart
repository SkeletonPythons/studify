              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage:
                    AssetImage('assets/images/user.png'), //Changed to this for now because, since it still can't grab the actual user name, when maneuvering away from the page the name would clear and crash the app
                    radius: 25,
                    /*child: homeController.photoUrl!.value == ''
                        ? Text(
                        '${Auth.instance.USER.name.substring(0, 1)
                            .toUpperCase()}${Auth.instance.USER.name.split(
                            ' ')[1][0]
                            .toUpperCase()}') // <- this is the first letter of the first and last name
                        : null,*/
                  ),
                ),
              ],
